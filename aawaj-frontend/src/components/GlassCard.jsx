/**
 * GlassCard — Figma-accurate glassmorphism card
 *
 * Props:
 *   label (string)       — tiny uppercase heading text (optional)
 *   children (ReactNode) — card content
 *   className (string)   — extra Tailwind classes (optional)
 *   rounded (string)     — border radius, default "rounded-[50px]"
 */
export default function GlassCard({ label, children, className = "", rounded = "rounded-[24px]" }) {
  return (
    <div
